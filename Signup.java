...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Create-Account", TitledBorder.TOP, TitledBorder.CENTER, null, new Color(172, 216, 230)));
